...
# Perform Filter Method (SelectKBest with ANOVA F-value)
selector = SelectKBest(score_func=f_classif, k='all')  # Keeping all features to evaluate their importance
...
print(f"\nBest Number of Features for KNN using Filter Method (after 5 experiments): {best_num_features}")
...
# Display results
print(f"\nKNN Accuracy for Different K Values (Filter Method, 5 Runs):")
print(knn_results)
...
plt.ylabel("Accuracy")
plt.title("KNN Accuracy vs Number of Features (Filter Method, 5 Runs)")
